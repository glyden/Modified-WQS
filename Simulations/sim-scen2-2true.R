...
# with competing methods in a setting with two true predictors out of 10, with differing effect sizes.
...
# set path
path="~/Desktop/Sim-2True/Results/"
...
# r2(betas,my.sigma,sd.error^2) # test
